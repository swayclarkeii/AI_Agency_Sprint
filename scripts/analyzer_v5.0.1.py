...
def latest_fetch_path() -> Path | None:
    """Return the most recently modified fetch_*.json in FETCHER_RUNS_DIR."""
...
def validate_contract(obj: dict) -> (bool, str):
    try:
        ...
        if obj.get("version") != "analyzer_v4": return False, "bad version"
