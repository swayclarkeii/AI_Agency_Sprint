...
def validate_frameworks():
    """Validate all YAML framework files before starting the pipeline"""
    yaml_files = {
        "Shortform Script Framework": SF_FRAMEWORK,
        "Newsletter Framework": NEWS_FRAMEWORK,
        "B-roll Prompt Framework": BROLL_PROMPT_FRAMEWORK,
    }
    ...
    if not all_valid:
        print("\n❌ Framework validation failed. Fix the errors above before continuing.\n")
        raise SystemExit(1)
